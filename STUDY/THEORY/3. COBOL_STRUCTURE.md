...
### Hiển thị và format syntax COBOL

Trong VSC, cài extension COBOL

![Image](../../images/vsc-cobol-extension.png)

Lúc này, viết markdown code có kèm syntax \`\`\`cobol...\`\`\` sẽ giúp highlight code tương tự như code thật và các file `.cbl`, `.cob` sẽ được format ở dạng fixed format.

![Image](../../images/vsc-cobol-extension-demo.png)
